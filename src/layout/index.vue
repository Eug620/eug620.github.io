...
<template>
  <div class="w-screen	h-screen pt-14">
    <div
      class="animate__animated animate__fadeIn fixed bg-slate-100 overflow-x-auto overflow-y-hidden z-10 h-14 leading-14 top-0 w-screen shadow-md flex items-center pt-2 justify-center">
