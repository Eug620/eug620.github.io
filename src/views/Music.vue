...
<template>
    <div class="music">
        <div class="w-full flex flex-col  py-4  flex-wrap  w-full max-w-screen-lg px-2 mx-auto">
            <div v-if="MusicStore.pic_url" @click="MusicStore.useChangeStatus"
                class="my-10 flex-1 cursor-pointer text-center flex flex-col justify-items-center pr-2 pt-1">
                <img @click="MusicStore.useGetMusic" :src="MusicStore.pic_url"
                    class="h-32  mb-4 rounded-full mx-auto  cursor-pointer" v-if="MusicStore.pic_url" alt="下一首">
            ...
            <div class="flex-1 h-full overflow-y-auto">
                <div class="cursor-pointer h-12 flex mb-2 bg-slate-200 rounded-lg overflow-hidden"
                    ...
                    <img :src="music.pic_url" class="h-12 mr-4" alt="" @click="MusicStore.usePlay(music)">
